    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Sua biometria foi registrada com sucesso para login futuro",
        });
      ...
      <Dialog open={biometricDialogOpen} onOpenChange={setBiometricDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Registre sua impressão digital ou reconhecimento facial para acessar o app 
              mais rapidamente nas próximas vezes
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Este nome será usado para identificar este dispositivo nas suas configurações
              </p>
            </div>
          </div>
