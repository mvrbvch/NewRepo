  ...
  return (
    <header className="px-4 py-3 flex items-center justify-between border-b bg-white">
      <div className="flex items-center">
        <Link href="/">
          <a className="text-xl font-bold text-primary">NossaRotina</a>
        </Link>
      </div>
          ...
          <DropdownMenuContent className="w-56" align="end">
              ...
              {!user?.partnerId && (
                <Link href="/invite-partner">
                  <DropdownMenuItem className="cursor-pointer" asChild>
                    <a>
                      <span className="material-icons mr-2 text-gray-500 text-sm">people</span>
            ...
            >
              {logoutMutation.isPending ? (
                <>
                  <span className="material-icons mr-2 text-red-500 text-sm animate-spin">autorenew</span>
                  <span>Saindo...</span>
                </>
              ) : (
                <>
                  <span className="material-icons mr-2 text-red-500 text-sm">logout</span>
                  <span>Sair</span>
                </>
              )}
            </DropdownMenuItem>
