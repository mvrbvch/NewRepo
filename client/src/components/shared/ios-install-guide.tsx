        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-6 py-4">
            <div className="flex gap-4 items-start">
              <div className="w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center flex-shrink-0">1</div>
              <div>
                <h3 className="font-medium">Toque no botão de compartilhar</h3>
                <p className="text-sm text-muted-foreground">
                  Encontre o botão <Share2 className="inline h-4 w-4" /> na barra de navegação do Safari 
                  (geralmente na parte inferior em iPhones ou no topo em iPads).
                </p>
              </div>
            </div>
            
            <div className="flex gap-4 items-start">
              <div className="w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center flex-shrink-0">2</div>
              <div>
                <h3 className="font-medium">Selecione "Adicionar à Tela de Início"</h3>
                <p className="text-sm text-muted-foreground">
                  Deslize para cima no menu de compartilhamento até encontrar a opção 
            ...
            <div className="flex gap-4 items-start">
              <div className="w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center flex-shrink-0">3</div>
              <div>
                <h3 className="font-medium">Confirme a instalação</h3>
                <p className="text-sm text-muted-foreground">
                  Verifique o nome e URL e toque em "Adicionar" no canto superior direito.
                </p>
              </div>
            </div>
