...
/**
 * Detecta se o dispositivo atual é um dispositivo móvel com base no 
 * tamanho da tela e no User Agent
 */
export function isMobile(): boolean {
  // Verifica se estamos no navegador
  if (typeof window === 'undefined') return false;
  
  // Verifica primeiro pelo user agent
  ...
  // Verifica também pelo tamanho da tela
